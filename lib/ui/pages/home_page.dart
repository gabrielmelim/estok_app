  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'ESTOK APP',
          style: TextStyle(color: Color.fromRGBO(88, 53, 94, 1)),
        ),
        centerTitle: true,
      ...
      drawer: SafeArea(
        child: Drawer(
          child: ListView(
            children: [
              ScopedModelDescendant<UsuarioModel>(builder:
                  (BuildContext context, Widget child,
                      UsuarioModel usuarioModel) {
                return UserAccountsDrawerHeader(
                  currentAccountPicture: CircleAvatar(
                    backgroundImage: NetworkImage(
                        'https://raw.githubusercontent.com/gabrielmelim/imgs/main/FlutterIndra/Ellipse%209.png'),
                  ),
                  ...
                  accountEmail:
                      Text(usuarioModel.usuario.email ?? 'usuario@email.com'),
                );
              }),
              SizedBox(height: 15),
              ListTile(
